  ...
  return (
    <div>
      ...
      <div className='marquee'>
              <marquee direction="up" height="400" width="800" bgcolor="black" color="yellow">“It is a period of civil war. Rebel spaceships, striking from a hidden base, have won their first victory against the evil Galactic Empire.
